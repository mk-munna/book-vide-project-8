        ...
        <div className='lg:mt-20 lg:mb-28 mt-6 mx-auto lg:w-[1000px]'>
            ...
            <div className='mt-20  flex flex-col  gap-28  lg:flex-row'>
                ...
                <div className='space-y-8'>
                    <h2 className='font-playFairDisplay text-5xl font-semibold'>Join our newsletter</h2>
                    <p>Stay up-to-date with the latest literary releases by joining our newsletter. As a book lover, you'll gain access to a wealth of exciting content delivered straight to your inbox. </p>
                    <div>
                    ...
                    <div className='flex gap-16'>
                        ...
                        <div>
                            <h3 className='font-semibold'>Alternative contact of us</h3>
