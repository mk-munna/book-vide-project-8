                ...
                <div className='flex gap-6 my-10'>
                    ...
                    <div className='space-y-4'>
                        ...
                        <div className='flex gap-4'>
                            ...
                            <NavLink to={`/book/${bookId}`}><button className='btn min-h-1 h-[42px] px-4 py-2 rounded-full bg-[#23BE0A] text-white text-base hover:bg-[#348a26]'>View Details </button></NavLink>
                        </div>
                    </div>
                </div>
            </div>
