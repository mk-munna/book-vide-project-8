    ...
    return (
        <div className='mt-12 h-[550px] rounded-3xl lg:flex justify-between items-center bg-[#1313130D] lg:px-[120px] px-6'>
            <div className='space-y-12'>
                <h1 className='text-4xl pt-12 lg:pt-0 lg:text-6xl'>Books to freshen up your bookshelf</h1>
                <div>
            ...
            <div>
                <img className='lg:w-full w-52 mt-10 lg:mt-0' src="https://i.ibb.co/r2k13p0/banner.png" alt="banner image book" />
            </div>
        </div>
    );
};
